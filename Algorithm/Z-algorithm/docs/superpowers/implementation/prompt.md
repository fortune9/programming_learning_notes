# Z-Algorithm Tutorial Implementation Prompts

This document contains task-specific prompts for implementing the Z-algorithm tutorial. Each task can be executed by a separate subagent.

---

## Task 1: Python Implementation (Core Algorithm)

**Objective:** Create `programming_learning_notes/Algorithm/Z-algorithm/z_algorithm.py` with three implementation versions and test examples.

**Files to create:**
- `programming_learning_notes/Algorithm/Z-algorithm/z_algorithm.py`
...
Expected output: Clean output showing Z-arrays for test strings

### Step 3: Add educational version with extensive comments

Add this function BEFORE the production `z_algorithm` function:
...
Add this function AFTER the production `z_algorithm` function:
...
- Contains all three functions: `z_algorithm_educational`, `z_algorithm`, `z_algorithm_search`
- Running the file produces output with Z-arrays and pattern matching results
...
**Objective:** Create the tutorial markdown file with front matter, TOC, and first two sections.

**Files to create:**
- `programming_learning_notes/Algorithm/Z-algorithm/z-algorithm-tutorial.md`

**Implementation:**

Create the file with this complete content (sections 1-2):
...
**Validation:**
- File exists at correct path
- Contains complete front matter with date, difficulty, tags
- TOC has all 12 sections with markdown anchor links
- Sections 1 and 2 are complete with all subsections
- ASCII diagrams are properly formatted and aligned
- Code blocks use correct syntax highlighting (none/text for examples)
- Internal section links use correct markdown format

---

## Task 3: Tutorial Section 3 (Naive Approach)

**Objective:** Add Section 3 explaining the naive approach and why it fails.
...
Append this content to the tutorial file:
...
**Validation:**
- Content appended correctly after Section 2
- Section numbering is correct (Section 3)
- Code blocks have proper Python syntax highlighting
- ASCII diagrams aligned properly
- Markdown formatting consistent with previous sections
- Internal logic flow is clear (algorithm → problem → insight → complexity)

---

## Task 4: Tutorial Section 4 (Optimization Strategy)

**Objective:** Add Section 4 explaining the Z-box concept, mirror insight, and two cases.
...
Append this complete Section 4:
...
**Validation:**
- Section appended after Section 3
- Contains all three parts (A, B, C)
- ASCII diagrams properly aligned
- Code blocks and pseudocode formatted correctly
- Mathematical notation clear (k = i - L, etc.)
- Internal subsection structure correct

---

## Task 5: Tutorial Section 5 (Visual Walkthrough)

**Objective:** Add Section 5 with complete step-by-step visual walkthrough of "aabcaabxaay".
...
Append this complete Section 5 with all 10 steps:
...
**Validation:**
- Section appended correctly after Section 4
- All 10 steps present and complete
- Each step shows: status, action, comparisons, result
- ASCII diagrams consistent and aligned
- Z-box visualization clear at each step
- Final observations summarize key points
- Markdown formatting consistent

---

## Task 6: Tutorial Sections 6-7 (Algorithm Breakdown & Example)

**Objective:** Add Sections 6 and 7 with detailed algorithm pseudocode and step-by-step table example.
...
**Validation:**
- Sections 6 and 7 appended after Section 5
- Pseudocode properly formatted with Python syntax
- Line-by-line explanations cover all logic branches
- Table in Section 7 properly formatted with markdown
- Final narrative provides detailed examples for key steps
- Comparison count demonstrates optimization benefit
...
**Objective:** Add Sections 8 and 9 covering Python implementation references and complexity analysis.
...
**Validation:**
- Sections 8 and 9 appended correctly
- Code examples reference the z_algorithm.py file
- All three implementation versions shown
- Complexity analysis includes proof sketch
- Comparison table properly formatted
- Mathematical notation clear (O(n), O(n²))

---

## Task 8: Tutorial Sections 10-12 (Applications, Practice, References)

**Objective:** Add final sections covering applications, practice problems, and references.
...
Append Sections 10, 11, and 12 to complete the tutorial:
...
**Validation:**
- Sections 10, 11, and 12 complete the tutorial
- Section 10 covers 5 major application areas with code examples
- Section 11 has 7 practice problems with hints in collapsible details
- Section 12 provides comprehensive references across multiple categories
- Conclusion summarizes key learnings and next steps
- Footer links to related files
...
**Objective:** Create the solutions document for practice problems.

**Files to create:**
- `programming_learning_notes/Algorithm/Z-algorithm/z-algorithm-solutions.md`

**Implementation:**

Create the complete solutions file:
...
- Contains solutions for Problems 1, 2, 3, 4, and 6
- Each solution includes: problem statement, approach, code, output, explanation
- Code examples import from z_algorithm.py
- Formatting consistent with tutorial style
- Note about Manacher's algorithm for Problem 6

---

## Task 10: Final Review and Formatting

**Objective:** Perform comprehensive validation of all deliverables.
...
### Step 1: Verify Python implementation runs correctly

Run the Python file and verify output:

```bash
cd /home/ubuntu/work/github/programming_learning_notes/Algorithm/Z-algorithm
python z_algorithm.py
```

**Expected output:**
- Header with "Z-Algorithm Examples"
- Example 1 showing Z-array for "aabcaabxaaz"
- Example 2 showing pattern matching results for "abab" in "ababcababcabab"
- Positions list: [0, 5, 10]
- Verification showing matched substrings

**Check:**
- No Python syntax errors
- All three functions present (z_algorithm_educational, z_algorithm, z_algorithm_search)
- Output format matches expected

### Step 2: Validate tutorial file structure

Check the tutorial markdown file:

```bash
ls -lh /home/ubuntu/work/github/programming_learning_notes/Algorithm/Z-algorithm/z-algorithm-tutorial.md
```

**Verify content:**
- File exists and has reasonable size (>50KB)
- Contains all 12 sections
- Front matter present (Date, Difficulty, Tags)
- Table of Contents with 12 anchor links
- ASCII diagrams aligned properly
- Code blocks have correct syntax highlighting
- Internal links formatted correctly ([text](link))
...
### Step 3: Validate solutions document

Check the solutions file:

```bash
ls -lh /home/ubuntu/work/github/programming_learning_notes/Algorithm/Z-algorithm/z-algorithm-solutions.md
```

**Verify:**
- File exists
- Contains solutions for Problems 1, 2, 3, 4, 6
- Code examples properly formatted
- Imports reference z_algorithm.py correctly
- Explanations clear and complete

### Step 4: Test all internal links

From the tutorial, verify these links work:
- `[z_algorithm.py](z_algorithm.py)` (referenced in Section 8)
- `[z-algorithm-solutions.md](z-algorithm-solutions.md)` (referenced in Sections 11 and 12)

**Check:**
- Relative paths are correct
- Files exist at referenced locations
...
```
programming_learning_notes/Algorithm/Z-algorithm/
├── z_algorithm.py
...
**Tutorial (z-algorithm-tutorial.md):**
- [ ] All 12 sections complete and numbered correctly
- [ ] TOC matches actual section structure
- [ ] ASCII diagrams aligned and clear
- [ ] Code examples syntactically correct
- [ ] Explanations progress logically from basic to advanced
- [ ] Complexity analysis rigorous and complete
- [ ] Practice problems have hints
- [ ] References comprehensive

**Implementation (z_algorithm.py):**
- [ ] Three versions present (educational, production, search)
- [ ] Educational version heavily commented
- [ ] Production version clean and concise
- [ ] Pattern matching function complete
- [ ] Helper function for visualization included
- [ ] Main block with examples executes correctly
- [ ] No syntax or runtime errors

**Solutions (z-algorithm-solutions.md):**
- [ ] Solutions for Easy problems (1-2) complete
- [ ] Solutions for Medium problems (3-4) complete
- [ ] Solution for Hard problem (6) complete
...
- [ ] **File 1:** `z_algorithm.py` - Complete with 3 implementations, tested and working
- [ ] **File 2:** `z-algorithm-tutorial.md` - Complete with all 12 sections, TOC, diagrams
- [ ] **File 3:** `z-algorithm-solutions.md` - Complete with solutions for 5 problems
- [ ] All files in correct directory structure
- [ ] All internal links functional
- [ ] Python code executes without errors
- [ ] Tutorial is comprehensive and educational
- [ ] Solutions provide clear explanations
...
**Task dependencies:**
- Task 1 must complete before Task 2 (tutorial references Python file)
- Tasks 2-8 can proceed sequentially (building tutorial sections)
- Task 9 can run in parallel after Task 1 (only depends on Python file)
- Task 10 requires all other tasks complete

**Estimated execution time:**
- Task 1: 15-20 minutes (Python implementation + testing)
- Tasks 2-8: 60-90 minutes (tutorial writing)
- Task 9: 20-30 minutes (solutions document)
- Task 10: 15-20 minutes (comprehensive validation)
- **Total: ~2-3 hours**

**Parallelization opportunities:**
- Task 1 → (Task 2-8 in parallel with Task 9) → Task 10
- Maximum parallelism: 2 agents working simultaneously
...
1. **For serial execution:** Execute tasks 1-10 sequentially using a single subagent
2. **For parallel execution:** 
   - Launch Agent A for Task 1
   - After Task 1 completes, launch Agent B for Tasks 2-8 (tutorial) and Agent C for Task 9 (solutions) in parallel
   - After both complete, run Task 10 for final validation
3. **Each subagent should:**
   - Follow the implementation steps exactly
   - Include full code from the prompts (not placeholders)
   - Perform validation checks after each step
   - Report completion status and any issues found
